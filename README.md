...
completing its evaporation in the present epoch, builds an adaptive
...
black hole masses, as a sanity check on the underlying physics.
...
This is the key validation of the entire pipeline. It converts the
